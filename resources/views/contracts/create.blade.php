...
<div class="container mt-5">
    ...
    <div class="card shadow-lg p-4">
        ...
        <form action="{{ route('landlord.contracts.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
    ...
    <a href="{{ route('landlord.properties.show', $property->id) }}" class="btn btn-secondary">Back</a>
@else
    <a href="{{ route('landlord.properties.index') }}" class="btn btn-secondary">Back to Properties</a>
@endif
